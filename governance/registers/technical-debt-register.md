...
| TD-010 | Identity operations | The controlled Google project, provider, browser-key restrictions and billing budgets are configured; browser signup, recovery, revocation and audit/activity logging still require deployed rehearsal. | High | Complete synthetic browser and recovery rehearsal before invitations; keep real data and public activation frozen |
