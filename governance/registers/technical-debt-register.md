...
| TD-003 | Tenant boundary | Some repositories retrieve by globally supplied brand ID rather than an authorized tenant context. | Critical | Open ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â MLAI-027.3 |
| TD-008 | Campaign artifacts | Generated content and compliance reports require an injected artifact service and do not yet have a canonical relational repository. | High | Open ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â design before pilot export |
...
| TD-014 | Product use cases | Product Intelligence has no governed use-case field, so relevance reports the gap rather than inferring use cases. | Medium | Open ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â preserve as a limitation through MLAI-028.5 |
